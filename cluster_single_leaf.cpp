...
int main(int argc, char** argv)
{
    ...
    reader.read("E:\\seg_leave\\leave.ply", *cloud);
    ...
    normal_estimator.setRadiusSearch(0.01); // 使用半径在查询点周围2厘米范围内的所有邻元素
    ...
    reg.setResidualThreshold(0.1); // 设置搜索的近邻点数目
    ...
    for (size_t i = 0; i < clusters.size(); ++i) {
        ...
        // 为每个聚类创建一个文件名
        std::string filename = "E:\\seg_leave\\leave_" + std::to_string(i) + ".ply";
