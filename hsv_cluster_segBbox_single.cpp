...
void euclideanClustering(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& cloud, std::vector<pcl::PointIndices>& cluster_indices) {
    ...
    ec.setClusterTolerance(0.02); // 聚类时两点之间的最大距离//0.08before,0.05,0.025
...
int main(int argc, char** argv) {
    ...
    std::vector<std::string> patterns = { "jidou19"};
    // 原始文件和新文件的前缀
    std::string prefix = "./0718/0718_";
    std::string prefix_after = "./0718_single/0718_";
